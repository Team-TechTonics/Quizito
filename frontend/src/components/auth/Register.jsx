...
const Register = () => {
  ...
  const roles = [
    ...
    },
    {
      ...
      disabled: true // Disable educator role
    }
  ]
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {roles.map((role) => (
                        <button
                          ...
                          className={`p-4 rounded-xl border-2 transition-all relative ${role.disabled
                        ...
                        >
                          {role.disabled && (
                            <span className="absolute -top-2 -right-2 bg-gray-600 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded-full z-10">
                              Coming Soon
                            </span>
                          )}
                          <div className="flex items-center space-x-3">
                            <div className={`p-2 rounded-lg ${role.disabled
                  ...
                  <div>
                    ...
                    <div className="mt-3">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className={`text-sm font-medium ${passwordStrength < 50 ? 'text-red-600' :
                ...
                <div className="mt-8 pt-8 border-t">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button
                      type="button"
                      disabled
                      className="p-3 border-2 border-gray-100 bg-gray-50 rounded-xl flex items-center justify-center space-x-2 relative cursor-not-allowed opacity-60"
                    >
                      <span className="absolute -top-2 -right-2 bg-gray-600 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded-full z-10">
                        Coming Soon
                      </span>
                      <svg className="w-5 h-5 grayscale" fill="currentColor" viewBox="0 0 24 24">
