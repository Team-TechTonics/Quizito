...
import { 
  ...
  Sparkles, ArrowRight, AlertCircle, Chrome as ChromeIcon
} from 'lucide-react';
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-4 py-3 bg-gray-50 border-2 rounded-xl focus:ring-2 ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full pl-12 pr-12 py-3 bg-gray-50 border-2 rounded-xl focus:ring-2 ${
