        ...
        <div className="max-w-md mx-auto">
          ...
          <Link to="/" className="inline-flex items-center space-x-3 group">
            ...
            <div>
              ...
              <p className="text-gray-600">{t('auth.subtitle', 'AI-Powered Quiz Platform')}</p>
            </div>
          </Link>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-800">{t('auth.welcome_back', 'Welcome Back')}</h2>
              <p className="text-gray-600 mt-2">{t('auth.sign_in_to_continue', 'Sign in to continue to Quizito')}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Email */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">{t('auth.email_label', 'Email Address')}</label>
              ...
              {/* Password */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">{t('auth.password_label', 'Password')}</label>
                <div className="relative">
              ...
              >
                {authLoading ? (
                  <>
                    ...
                    <span>{t('auth.sign_in_button', 'Signing in...')}</span>
                  </>
                ) : (
                  <>
                    <LogIn size={24} /> <span>{t('auth.sign_in_button', 'Sign In')}</span> <ArrowRight size={20} />
                  </>
                )}
              </motion.button>
            </form>
            ...
            >
              ...
              {t('auth.demo_account', 'Try Demo Account')}
            </motion.button>
            ...
            >
              <Github size={20} />
              <span>{t('auth.github_login', 'Sign in with GitHub')}</span>
            </motion.button>
